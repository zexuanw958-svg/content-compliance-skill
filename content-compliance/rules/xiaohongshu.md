...
Severity: 3
Trigger Scenarios: A note planned for Shutiao promotion involves at least one substantive restriction signal: prohibited category, qualification-gated category, missing industry qualification, low-quality marketing pattern, or false/exaggerated commercial claim.
...
Evidence Extraction: Check note category, restricted product or service involved, qualification materials, title and cover variants, landing page, low-quality-marketing pattern, false/exaggerated commercial claim, and any regulated-industry signals.
